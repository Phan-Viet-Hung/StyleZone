...
namespace DAL_Empty.Migrations
{
    ...
    [Migration("20250703084859_fix-code-db")]
    partial class fixcodedb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL_Empty.Models.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasKey("Id")
                        .HasName("PK__ChatMess__3214EC27B941F150");
            ...
            modelBuilder.Entity("DAL_Empty.Models.ChatSession", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__ChatSess__3214EC278B069E58");
            ...
            modelBuilder.Entity("DAL_Empty.Models.Rating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Rating__3214EC27BBD31BB6");
            ...
            modelBuilder.Entity("DAL_Empty.Models.ReturnRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasKey("Id")
                        .HasName("PK__ReturnRe__3214EC271C31DF75");
            ...
            modelBuilder.Entity("DAL_Empty.Models.ChatMessage", b =>
                {
                    b.HasOne("DAL_Empty.Models.ChatSession", "ChatSession")
            ...
            modelBuilder.Entity("DAL_Empty.Models.ReturnRequest", b =>
                {
                    b.HasOne("DAL_Empty.Models.OrderDetail", "OrderDetail")
